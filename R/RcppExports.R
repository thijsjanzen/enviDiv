...
#' @export
create_tree_cpp <- function(parameters, waterlevel_changes, crown_age, max_lin) {
    .Call('_enviDiv_create_tree_cpp', PACKAGE = 'enviDiv', parameters, waterlevel_changes, crown_age, max_lin)
}
...
#' @export
param_from_prior_cpp <- function(model = -1L) {
    .Call('_enviDiv_param_from_prior_cpp', PACKAGE = 'enviDiv', model)
}
...
#' perturbation, the chosen water model
#' @export
param_from_prior_exp_cpp <- function(model = -1L) {
    .Call('_enviDiv_param_from_prior_exp_cpp', PACKAGE = 'enviDiv', model)
}
